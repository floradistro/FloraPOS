...
export function SettingsDropdown({ isOpen, onClose, onToggle }: SettingsDropdownProps) {
  ...
  return (
    <div 
      ref={dropdownRef}
      className="w-full bg-neutral-900/95 backdrop-blur-sm border border-white/[0.08] rounded-lg shadow-lg overflow-hidden"
    >
      {/* Header */}
      ...
      {/* User Info */}
      {user && (
        <div className="px-4 py-3 border-b border-white/[0.06] bg-neutral-850/30">
      ...
      <div className="py-1">
        ...
        <button
          ...
          className="w-full px-4 py-2 text-left text-sm text-neutral-300 hover:bg-white/[0.03] hover:text-neutral-200 transition-all duration-150 flex items-center gap-3 group"
        >
      ...
      <div className="border-t border-white/[0.06] py-2">
        <button
          ...
          className="w-full px-4 py-2 text-left text-sm text-red-400 hover:bg-red-500/[0.08] hover:text-red-300 transition-all duration-150 flex items-center gap-3 group"
        >
