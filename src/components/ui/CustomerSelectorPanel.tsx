      ...
      <div className="px-4 py-3 border-b border-neutral-700/50 bg-neutral-800/50">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2 bg-neutral-700/50 border border-neutral-600/50 rounded-lg text-neutral-300 text-sm placeholder-neutral-500 focus:border-neutral-500 focus:outline-none"
          />
        ...
        {loading ? (
          ...
          <div className="py-2">
            {filteredCustomers.map((customer) => (
              ...
              >
                <div className="w-8 h-8 bg-neutral-700/50 rounded-full flex items-center justify-center group-hover:bg-blue-600/20 transition-colors">
                  <svg className="w-4 h-4 text-neutral-500 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </div>
