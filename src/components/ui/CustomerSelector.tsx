...
export function CustomerSelector({ 
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
        ...
        <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
          {selectedCustomer && (
            <button
              ...
              className="p-0.5 text-neutral-400 hover:text-neutral-300 transition-colors"
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 py-2 bg-neutral-800 rounded shadow-xl z-50 max-h-64 overflow-y-auto">
          {loading ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full text-left px-2 py-2 hover:bg-neutral-700/50 text-neutral-300 text-sm transition-colors"
              >
