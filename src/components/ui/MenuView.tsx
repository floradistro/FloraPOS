        ...
        <div className="flex-1 overflow-y-auto">
          {productsByCategory.length === 0 ? (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <p className="text-2xl text-neutral-300 mb-3">No products currently available</p>
    ...
    <div className="flex-1 flex flex-col p-6 bg-transparent">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>Orientation:</span>
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-all duration-200 ease-out ${
                  orientation === 'horizontal' 
                    ...
                    : 'text-neutral-500 hover:text-neutral-300 bg-transparent border border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50'
                }`}
          ...
          <div className="flex items-center gap-3">
            {/* Category Selector */}
            <div className="flex items-center gap-2">
              <span className="text-sm text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>Category:</span>
              <select
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-3 h-[30px] text-sm transition-all duration-200 ease-out rounded-lg border whitespace-nowrap bg-transparent text-neutral-500 border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50 hover:text-neutral-300"
              style={{ fontFamily: 'Tiempo, serif' }}
            >
          ...
          {getUniqueCategories().map(category => {
            ...
            return (
              <button
                ...
                className="rounded-lg p-4 text-left transition-all duration-200 ease-out border bg-transparent text-neutral-500 border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50 hover:text-neutral-300 group"
                style={{ fontFamily: 'Tiempo, serif' }}
              >
                ...
                <div className="text-xs text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1 text-neutral-500 hover:text-neutral-300 transition-all duration-200 ease-out"
                        title="Focus Window"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="rounded-lg p-4 border bg-transparent border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50 transition-all duration-200 ease-out">
          ...
          <div className="text-sm text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>
        ...
        <div className="rounded-lg p-4 border bg-transparent border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50 transition-all duration-200 ease-out">
          ...
          <div className="text-sm text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>Categories</div>
        </div>
        <div className="rounded-lg p-4 border bg-transparent border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50 transition-all duration-200 ease-out">
          <div className="text-2xl font-bold text-white capitalize" style={{ fontFamily: 'Tiempo, serif' }}>{orientation}</div>
          <div className="text-sm text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>Display Mode</div>
        </div>
        <div className="rounded-lg p-4 border bg-transparent border-neutral-500/30 hover:bg-neutral-600/10 hover:border-neutral-400/50 transition-all duration-200 ease-out">
          <div className="text-2xl font-bold text-white" style={{ fontFamily: 'Tiempo, serif' }}>{user?.location || 'Unknown'}</div>
          <div className="text-sm text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>Location</div>
        </div>
      </div>
      ...
      <div className="flex-1 rounded-lg overflow-hidden border border-neutral-500/30 bg-transparent">
        ...
        <div className="relative bg-transparent p-6">
          {productsByCategory.length === 0 ? (
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                <p className="text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>No products available for preview</p>
                <p className="text-sm text-neutral-500 mt-2" style={{ fontFamily: 'Tiempo, serif' }}>Add products to see live menu previews</p>
              </div>
            </div>
          ) : (
                ...
                return (
                  <div key={category.id} className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-neutral-400" style={{ fontFamily: 'Tiempo, serif' }}>
        ...
        <div className="p-3 border-t border-neutral-500/30">
          <div className="text-xs text-neutral-500 text-center" style={{ fontFamily: 'Tiempo, serif' }}>
      ...
      {showDualMenuSelector && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="rounded-xl p-8 max-w-2xl w-full mx-4 border border-neutral-500/30 bg-neutral-900/80 backdrop-blur-sm">
            ...
            <p className="text-neutral-300 mb-8 text-lg" style={{ fontFamily: 'Tiempo, serif' }}>
            ...
            <div className="grid grid-cols-2 gap-8 mb-8">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-transparent hover:bg-neutral-600/10 border border-neutral-500/30 hover:border-neutral-400/50 rounded-lg text-neutral-400 text-base focus:bg-neutral-600/10 focus:border-neutral-300 focus:outline-none transition-all duration-200 ease-out"
                >
